...
map->cadre=IMG_Load("MINIMAP/CHINAMAPCADREFINALE.png");
map->point=IMG_Load("MINIMAP/pointvert.png");
map->pointEnemy=IMG_Load("MINIMAP/pointrougenoire1.png");
...
map->pointEntite=IMG_Load("MINIMAP/pointrouge1.png");
...
ImageFond->image[0]=IMG_Load("BACKGROUND/china1.png");
ImageFond->image[1]=IMG_Load("BACKGROUND/china2.png");
ImageFond->image[2]=IMG_Load("BACKGROUND/china3.png");
ImageFond->image[3]=IMG_Load("BACKGROUND/china4.png");
ImageFond->image[4]=IMG_Load("BACKGROUND/china5.png");
...
strcpy(matrice[0],"spritesheet/enemy.png");
strcpy(matrice[2],"spritesheet/enemy.png");
strcpy(matrice[1],"spritesheet/enemy.png");
strcpy(matrice[3],"spritesheet/enemy.png");
strcpy(matrice[4],"spritesheet/enemy.png");
strcpy(matrice[5],"spritesheet/enemy.png");
strcpy(matrice[6],"spritesheet/enemy.png");
strcpy(matrice[7],"spritesheet/enemy.png");
strcpy(matrice[8],"spritesheet/enemy.png");
strcpy(matrice[9],"spritesheet/enemy.png");
strcpy(matrice[10],"spritesheet/enemy.png");
strcpy(matrice[11],"spritesheet/enemy.png");
strcpy(matrice[12],"spritesheet/enemy.png");
strcpy(matrice[13],"spritesheet/enemy.png");
strcpy(matrice[14],"spritesheet/enemy.png");
strcpy(matrice[15],"spritesheet/enemy.png");
...
strcpy(matrice[0][0].mot,"entite/skeleton4.png");
strcpy(matrice[1][0].mot,"entite/skeleton0.png");
...
strcpy(matrice[0][1].mot,"entite/deadman.png");
strcpy(matrice[1][1].mot,"entite/skeleton2.png");
strcpy(matrice[2][1].mot,"entite/pile.png");
//strcpy(matrice[3][1].mot,"skeleton2.png");
//strcpy(matrice[4][1].mot,"point rouge.png");

//background"3"
TabEntity[2].nbr_entite=4;
strcpy(matrice[0][2].mot,"entite/skeleton3.png");
strcpy(matrice[1][2].mot,"entite/pile.png");
strcpy(matrice[2][2].mot,"entite/skeleton0.png");
strcpy(matrice[3][2].mot,"entite/trashbag.png");
//strcpy(matrice[4][2].mot,"point rouge.png");

//background"4"
TabEntity[3].nbr_entite=5;
strcpy(matrice[0][3].mot,"entite/plant.png");
strcpy(matrice[1][3].mot,"entite/skeleton3.png");
strcpy(matrice[2][3].mot,"entite/pile.png");
strcpy(matrice[3][3].mot,"entite/skeleton1.png");
strcpy(matrice[4][3].mot,"entite/skull.png");

//background"5"
TabEntity[4].nbr_entite=5;
strcpy(matrice[0][4].mot,"entite/plant.png");
strcpy(matrice[1][4].mot,"entite/skeleton1.png");
strcpy(matrice[2][4].mot,"entite/trashbag.png");
strcpy(matrice[3][4].mot,"entite/skeleton4.png");
strcpy(matrice[4][4].mot,"entite/skeleton3.png");
...
void initHero(Hero *hero)
{
	...
	hero->spriteHero=IMG_Load("spritesheet/spritesheet.png");
...
//death init
	...
	hero->font = TTF_OpenFont("Font/SuperstarM54.ttf",32);
	hero->score = 0;
...
temps->font0=TTF_OpenFont("Font/digital-7.ttf",30);
temps->font1=TTF_OpenFont("Font/test.ttf",20);
